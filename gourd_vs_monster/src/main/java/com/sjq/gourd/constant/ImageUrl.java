...
public class ImageUrl {
    ...
    public static void initImageUrl() {
        ...
        gameOverImageMap.put(Constant.gameOverState.DEFEAT_ID,new Image("/images/gameOver/defeat.png"));
        gameOverImageMap.put(Constant.gameOverState.VICTORY_ID,new Image("/images/gameOver/victory.png"));
    }
}
